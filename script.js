  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          showError(field, name.charAt(0).toUpperCase() + name.slice(1) + ' must be at least ' + min + ' characters.');
          return false;
        }
      }
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Surf A Wave Co. uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'df58909b-03f1-4dc0-a605-844a3ec42cfd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'df58909b-03f1-4dc0-a605-844a3ec42cfd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'df58909b-03f1-4dc0-a605-844a3ec42cfd';
